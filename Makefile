...
browser: browser/JsGFF.js browser/JsGFF.min.js

# Build only the non-minified browser lib
dev-browser: browser/JsGFF.js
...
# Build the browser lib
browser/JsGFF.js: lib/*.js
	${BROWSERIFY} lib/JsGFF.js -i fs -i image-size -s JsGFF -o browser/JsGFF.js

# Build the browser minified lib
browser/JsGFF.min.js: browser/JsGFF.js
	${UGLIFY} browser/JsGFF.js -o browser/JsGFF.min.js -m
